...
import React, { useEffect, useId, useState } from "react"; // Removed unused useMemo
import Particles, { initParticlesEngine } from "@tsparticles/react";
import type { Container } from "@tsparticles/engine"; // Removed unused SingleOrMultiple
...
type ParticlesProps = {
  ...
  className?: string;
  background?: string;
  particleSize?: number; // Unused, but kept for compatibility
  minSize?: number;
  maxSize?: number;
  speed?: number;
          ...
          options={{
            ...
            interactivity: {
              events: {
                ...
                resize: {
                  enable: true, // Replaced 'true as any' with proper boolean
                },
              },
              modes: {
                push: {
